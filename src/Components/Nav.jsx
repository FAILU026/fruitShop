...
const Nav = () => {
  ...
  return (
    <nav className=' mt-5'>
      <div className='md:flex items-center  justify-between md:max-w-7xl mx-auto'>
        <div className=' flex justify-between'>
        <div>
      <span className=' text-green-500 font-bold text-4xl'>Vegetable</span>
          &nbsp;
      ...
      <div  className={` flex  md:block  justify-end ${open ? "block" : "hidden"}`}>
        <ul className=' md:flex space-x-8 space-y-7 md:space-y-0' >
          <li className='navList border-b-4 '>
